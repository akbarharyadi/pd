...
(function() {
  $(function() {
    ...
    $(document).on('change', '#pendataan_periode_awal', function(e) {
      ...
      if ($("#pendataan_kode_rekening").val() === '1104' || $("#pendataan_kode_rekening").val() === '1108') {
    ...
    $(document).on('change', '#pendataan_rekening_id', function(evt, params) {
      ...
      return $('#pendataan_nilai_reklame').val('');
    });
    ...
    $(document).on('change', '#pendataan_jumlah_volume', function(evt) {
    ...
    $(document).on('change', '#pegawai_bidang_id', function(evt) {
      return $.ajax('/seksis/update_seksi', {
        type: 'GET',
        dataType: 'json',
        data: {
    ...
    $(document).on('change', '#pendataan_nilai_reklame', function(evt) {
      var nilai, persen, rupiah;
      ...
      return $('#pendataan_jumlah_pajak').autoNumeric('set', nilai * (persen / 100));
    });
    return $(document).on('change', '#pendataan_npa', function(evt) {
      var nilai, persen, rupiah;
