...
class PendaftaransControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pendaftaran" do
    assert_difference('Pendaftaran.count') do
      post pendaftarans_url, params: { pendaftaran: { alamat_pemilik: @pendaftaran.alamat_pemilik, alamat_wp: @pendaftaran.alamat_wp, kecamatan_id: @pendaftaran.kecamatan_id, kelurahan_id: @pendaftaran.kelurahan_id, nama_pemilik: @pendaftaran.nama_pemilik, nama_wp: @pendaftaran.nama_wp, no_pendaftaran: @pendaftaran.no_pendaftaran, no_telp_pemilik: @pendaftaran.no_telp_pemilik, no_telp_wp: @pendaftaran.no_telp_wp, npwpd: @pendaftaran.npwpd, tgl_npwpd: @pendaftaran.tgl_npwpd, usaha_id: @pendaftaran.usaha_id } }
    end
  ...
  test "should update pendaftaran" do
    patch pendaftaran_url(@pendaftaran), params: { pendaftaran: { alamat_pemilik: @pendaftaran.alamat_pemilik, alamat_wp: @pendaftaran.alamat_wp, kecamatan_id: @pendaftaran.kecamatan_id, kelurahan_id: @pendaftaran.kelurahan_id, nama_pemilik: @pendaftaran.nama_pemilik, nama_wp: @pendaftaran.nama_wp, no_pendaftaran: @pendaftaran.no_pendaftaran, no_telp_pemilik: @pendaftaran.no_telp_pemilik, no_telp_wp: @pendaftaran.no_telp_wp, npwpd: @pendaftaran.npwpd, tgl_npwpd: @pendaftaran.tgl_npwpd, usaha_id: @pendaftaran.usaha_id } }
